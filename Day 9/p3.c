...
//1. Limited space for insertion (static)
//2. There can be space left in queue after dequeing but logically that space is unavailable (circular queue is the fix)